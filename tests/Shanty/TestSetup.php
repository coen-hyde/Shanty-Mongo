...
class Shanty_TestSetup extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		require_once 'My/ShantyMongo/Country.php';
        require_once 'My/ShantyMongo/Admin.php';
		...
		$this->_connection->selectDb(TESTS_SHANTY_MONGO_DB)->selectCollection('country')->drop();
	...
	public function populateDb()
	{
		...
		$this->_articles = array(
			'regular' => array(
                ...
                '_type' => array('My_ShantyMongo_Article'),
	...
	protected function _useMyIncludePath()
	{
		...
		set_include_path(dirname(__FILE__) . '/Mongo/_files/' . PATH_SEPARATOR . $this->_runtimeIncludePath);
	}
